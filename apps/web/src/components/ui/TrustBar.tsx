    ...
    <section style={{ background: designTokens.colors.white }}>
      <div className="mx-auto max-w-[1200px] px-8 py-12">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-lg border p-6 text-center hover:shadow-lg transition-shadow" style={{ borderColor: designTokens.colors.neutral[200] }}>
            <div className="mx-auto mb-2 h-8 w-8" style={{ color: designTokens.colors.primary[600] }} aria-hidden>
            ...
            <div className="text-sm" style={{ color: designTokens.colors.neutral[600] }}>Join 2,847+ creators</div>
          </div>
          <div className="rounded-lg border p-6 text-center hover:shadow-lg transition-shadow" style={{ borderColor: designTokens.colors.neutral[200] }}>
            <div className="mx-auto mb-2 h-8 w-8" style={{ color: designTokens.colors.primary[600] }} aria-hidden>
            ...
            <div className="text-sm" style={{ color: designTokens.colors.neutral[600] }}>$127K paid this month</div>
          </div>
          <div className="rounded-lg border p-6 text-center hover:shadow-lg transition-shadow" style={{ borderColor: designTokens.colors.neutral[200] }}>
            <div className="mx-auto mb-2 h-8 w-8" style={{ color: designTokens.colors.primary[600] }} aria-hidden>
            ...
            <div className="text-sm" style={{ color: designTokens.colors.neutral[600] }}>15,000+ community members</div>
          </div>
        </div>
      </div>
    </section>
